...
const page = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2'><div className=''><img src="/images/billingdetails1.svg" alt="billing form" /></div>
      <div><img src="/images/carddetails.svg" alt="payment card details" /></div></div>
